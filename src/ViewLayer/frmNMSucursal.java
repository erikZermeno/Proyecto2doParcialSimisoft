 ...
 * @author zerme
 */
public class frmNMSucursal extends javax.swing.JDialog {
    ...
    public frmNMSucursal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public frmNMSucursal(int idSucursal) throws ParseException {
        initComponents();
        setLocationRelativeTo(null);
        
        this.idSucursal = idSucursal;//Guardar el id mandado
        
        sucursal.setIdSucursal(idSucursal);
        sucursal.GetById();//Consulta por id
        ...
        llenarComboBoxContactos();
        contacto.setIdContacto(sucursal.getIdContacto());
        contacto.GetById();
        comboCalle.setSelectedItem(contacto.getCalle());
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtNombre.getText().isEmpty()) {
            ...
            if (idSucursal == 0) {
                if (new Sucursales(0, txtNombre.getText(), 
                ...
                sucursal.setIdContacto(idContacto.get(comboCalle.getSelectedIndex()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNMSucursal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmNMSucursal dialog = new frmNMSucursal(new javax.swing.JFrame(), true);
