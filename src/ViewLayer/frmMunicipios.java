...
public class frmMunicipios extends javax.swing.JInternalFrame {
    ...
    public frmMunicipios() {
        initComponents();
        tblMunicipios.setModel(new Municipios().GetAllModel());
        new TableDesing().desingOfTable(tblMunicipios);
        addInternalFrameListener(new InternalFrameAdapter(){
            public void internalFrameClosing(InternalFrameEvent e) {
                frmMain.fMunicipios = null;
                frmMain.btnMunicipios.setSelected(false);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        scroll.setViewportView(tblMunicipios);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if (tblMunicipios.getSelectedRow()>= 0) {           
            int idMunicipio = (int) tblMunicipios.getValueAt(tblMunicipios.getSelectedRow(), 0);
            
            frmNMMunicipio obj;
            try {
                obj = new frmNMMunicipio(idMunicipio);
                obj.setTitle("Modificar Municipio");
                obj.setModal(true);
                obj.setVisible(true);
            } catch (ParseException ex) {
                Logger.getLogger(frmMunicipios.class.getName()).log(Level.SEVERE, null, ex);
            }

            tblMunicipios.setModel(new Municipios().GetAllModel());

        }else{
            JOptionPane.showMessageDialog(rootPane, "Selecciona un municipio");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tblMunicipios.getSelectedRow()>= 0) {
            ...
            if(municipio.Delete()){
                JOptionPane.showMessageDialog(rootPane, "Municipio eliminado correctamente");
            }else {
                JOptionPane.showMessageDialog(rootPane, "No ha sido posible eliminar el municipio");
            }
            tblMunicipios.setModel(municipio.GetAllModel());
        }else{
            JOptionPane.showMessageDialog(rootPane, "Selecciona un municipio");
        }
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        tblMunicipios.setModel(new Municipios().GetAllModelOrderAsc());
        JOptionPane.showMessageDialog(rootPane, "Datos Ordenados");
    }//GEN-LAST:event_btnOrdenarActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        frmSMunicipio obj = new frmSMunicipio();
    ...
    public static javax.swing.JTable tblMunicipios;
