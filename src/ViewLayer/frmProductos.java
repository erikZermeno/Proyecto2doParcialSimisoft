...
public class frmProductos extends javax.swing.JInternalFrame {
    ...
    public frmProductos() {
        initComponents();
        tblProductos.setModel(new Productos().GetAllModel());
        new TableDesing().desingOfTable(tblProductos);
        addInternalFrameListener(new InternalFrameAdapter(){
            public void internalFrameClosing(InternalFrameEvent e) {
                frmMain.fProductos = null;
                frmMain.btnProductos.setSelected(false);
            }
        });
    }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if (tblProductos.getSelectedRow()>= 0) {           
            int idProducto = (int) tblProductos.getValueAt(tblProductos.getSelectedRow(), 0);
            
            frmNMProducto obj;
            try {
                obj = new frmNMProducto(idProducto);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tblProductos.getSelectedRow()>= 0) {
            ...
            if(producto.DeleteLogic()){
                JOptionPane.showMessageDialog(rootPane, "Producto eliminado correctamente");
            }else {
                JOptionPane.showMessageDialog(rootPane, "No ha sido posible eliminar el producto");
            }
            tblProductos.setModel(producto.GetAllModel());
        }else{
            JOptionPane.showMessageDialog(rootPane, "Selecciona un producto");
        }
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        tblProductos.setModel(new Productos().GetAllModelOrderAsc());
        JOptionPane.showMessageDialog(rootPane, "Datos Ordenados");
    }//GEN-LAST:event_btnOrdenarActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        frmSProducto obj = new frmSProducto();
