...
public class frmEstados extends javax.swing.JInternalFrame {
    ...
    public frmEstados() {
        initComponents();
        tblEstados.setModel(new Estados().GetAllModel());
        new TableDesing().desingOfTable(tblEstados);
        addInternalFrameListener(new InternalFrameAdapter(){
            public void internalFrameClosing(InternalFrameEvent e) {
                frmMain.fEstados = null;
                frmMain.btnEstados.setSelected(false);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        scroll.setViewportView(tblEstados);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if (tblEstados.getSelectedRow()>= 0) {           
            int idEstado = (int) tblEstados.getValueAt(tblEstados.getSelectedRow(), 0);
            
            frmNMEstado obj;
            try {
                obj = new frmNMEstado(idEstado);
            ...
            JOptionPane.showMessageDialog(rootPane, "Selecciona un estado");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tblEstados.getSelectedRow()>= 0) {
            ...
            if(estado.Delete()){
                JOptionPane.showMessageDialog(rootPane, "Estado eliminado correctamente");
            }else {
                JOptionPane.showMessageDialog(rootPane, "No ha sido posible eliminar el estado");
            }
            tblEstados.setModel(estado.GetAllModel());
        }else{
            JOptionPane.showMessageDialog(rootPane, "Selecciona un estado");
        }
    ...
    public static javax.swing.JTable tblEstados;
